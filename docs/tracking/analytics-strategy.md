...
Landed. The per-PR implementation contract for Phase 1 is preserved
at [`docs/plans/archive/analytics-phase-1-plan.md`](/docs/plans/archive/analytics-phase-1-plan.md).
