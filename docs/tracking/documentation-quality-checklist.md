...
- [x] A living release readiness and quality-check plan exists in
  [`docs/tracking/release-readiness.md`](/docs/tracking/release-readiness.md) and coordinates with
  the trackers in this file rather than duplicating them.

## Keep The Canonical Docs Honest

**Active correction sweep:** [`docs/plans/epics/docs-canonical-corrections/epic.md`](/docs/plans/epics/docs-canonical-corrections/epic.md)
