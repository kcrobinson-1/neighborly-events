...
| **B.2a** | `/event/:slug/redemptions` (read-only) | organizers (+ root admin) | list, filter, search, view | [`reward-redemption-phase-b-2a-plan.md`](./reward-redemption-phase-b-2a-plan.md) (Proposed) |
