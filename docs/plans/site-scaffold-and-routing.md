...
[`docs/operations.md`](/docs/operations.md) updates for the **final**
routing topology in M2; this phase touches it only if a contributor
following the doc would otherwise be misled about the
**transitional** state.

[`docs/open-questions.md`](/docs/open-questions.md) is touched only
...
- [`docs/self-review-catalog.md`](/docs/self-review-catalog.md) —
  ...
  audit
- [`docs/testing-tiers.md`](/docs/testing-tiers.md) — two-phase
