...
| --- | --- | --- | --- | --- |
| 2.1 | RLS broadening with pgTAP coverage | [m2-phase-2-1-plan.md](/docs/plans/archive/m2/m2-phase-2-1-plan.md) | Landed | [#108](https://github.com/kcrobinson-1/neighborly-events/pull/108), [#109](https://github.com/kcrobinson-1/neighborly-events/pull/109) |
| 2.2 | Per-event admin route shell at `/event/:slug/admin` | [m2-phase-2-2-plan.md](/docs/plans/archive/m2/m2-phase-2-2-plan.md) | Landed | [#113](https://github.com/kcrobinson-1/neighborly-events/pull/113), [#114](https://github.com/kcrobinson-1/neighborly-events/pull/114) |
| 2.3 | `/auth/callback` and `/` migration to apps/site | [m2-phase-2-3-plan.md](/docs/plans/archive/m2/m2-phase-2-3-plan.md) | Landed | [#118](https://github.com/kcrobinson-1/neighborly-events/pull/118), [#120](https://github.com/kcrobinson-1/neighborly-events/pull/120) |
| 2.4 | Platform admin migration to apps/site at `/admin` | [m2-phase-2-4-plan.md](/docs/plans/archive/m2/m2-phase-2-4-plan.md) | Landed | [#126](https://github.com/kcrobinson-1/neighborly-events/pull/126) |
| 2.5 | `/game/*` URL migration for operator routes | [m2-phase-2-5-plan.md](/docs/plans/archive/m2/m2-phase-2-5-plan.md) | Landed | [#130](https://github.com/kcrobinson-1/neighborly-events/pull/130), [#131](https://github.com/kcrobinson-1/neighborly-events/pull/131), [#133](https://github.com/kcrobinson-1/neighborly-events/pull/133) |
...
- [docs/architecture.md](/docs/architecture.md) — touched by every
...
- [docs/operations.md](/docs/operations.md) — owned by 2.4 (admin URL
  contract + Vercel routing topology) and 2.5 (operator URL
  references). Other phases don't touch operations.md.
- [docs/product.md](/docs/product.md) — owned by 2.5 (capability set
  after M2 completes). Other phases don't touch product.md.
- [docs/dev.md](/docs/dev.md) — owned by 2.3 (apps/site adapter +
...
- [docs/open-questions.md](/docs/open-questions.md) — owned by 2.5
...
- [docs/backlog.md](/docs/backlog.md) — owned by 2.5 (marks
...
- **Unblocked by M2.** "Organizer-managed agent assignment"
  ...
  [docs/backlog.md](/docs/backlog.md) by M2's terminal PR (2.5);
...
- **Opened by M2.** None planned. The epic's "Open Questions Newly
  ...
  [docs/open-questions.md](/docs/open-questions.md) in the same PR
...
- [m2-phase-2-1-plan.md](/docs/plans/archive/m2/m2-phase-2-1-plan.md),
  ...
  [m2-phase-2-5-3-plan.md](/docs/plans/archive/m2/m2-phase-2-5-3-plan.md) — per-phase
  plans.
...
- [docs/self-review-catalog.md](/docs/self-review-catalog.md) — audit
