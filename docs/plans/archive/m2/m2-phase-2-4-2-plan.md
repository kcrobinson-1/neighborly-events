...
Production Smoke** from [`docs/testing-tiers.md`](/docs/testing-tiers.md).
...
- [`docs/operations.md`](/docs/operations.md) — SPA rewrites list,
  `next=` allow-list example, smoke `curl` example context.
- [`docs/dev.md`](/docs/dev.md) — apps/web URL list, rule precedence
...
9. **`vercel dev` rule-order regression check** (negative-control
   ...
   [`m2-phase-2-3-plan.md`](/docs/plans/archive/m2/m2-phase-2-3-plan.md) Execution step
...
10. **Documentation pass.** Edit
    ...
    [`docs/dev.md`](/docs/dev.md), and check
...
2. **Documentation pass.**
   [`docs/architecture.md`](/docs/architecture.md) /
   [`docs/operations.md`](/docs/operations.md) /
   [`docs/dev.md`](/docs/dev.md) edits + [`README.md`](/README.md)
...
- **`vercel dev` rule-order regression check per Execution step 9**
  ...
  [`m2-phase-2-3-plan.md`](/docs/plans/archive/m2/m2-phase-2-3-plan.md); the apps/site
...
- **Post-release `Production Admin Smoke` run per Execution step
  ...
  Per [`docs/testing-tiers.md`](/docs/testing-tiers.md) "Plan-to-
...
- **Readiness-gate truthfulness audit**
  ([catalog §Readiness-gate truthfulness audit](/docs/self-review-catalog.md#L373)).
...
- **Platform-auth-gate config audit**
  ([catalog §Platform-auth-gate config audit](/docs/self-review-catalog.md#L446)).
...
- The 2.4.3 plan, the apps/web admin module ownership update in
  [`docs/architecture.md`](/docs/architecture.md), and SCSS prune
...
- [`m2-phase-2-4-plan.md`](/docs/plans/archive/m2/m2-phase-2-4-plan.md) — umbrella.
- [`m2-phase-2-4-1-plan.md`](/docs/plans/archive/m2/m2-phase-2-4-1-plan.md) — sibling
