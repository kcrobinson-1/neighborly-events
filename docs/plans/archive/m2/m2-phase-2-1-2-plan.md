...
- This plan — Status flips from `Proposed` to `Landed` in the
  implementing PR.
- [`m2-phase-2-1-plan.md`](/docs/plans/archive/m2/m2-phase-2-1-plan.md) — Status flips
  from `Proposed` to `Landed` (terminal sub-phase under the current
  sequencing).
...
- [`docs/operations.md`](/docs/operations.md) — no operator runbook
  change; the per-event admin URL contract is owned by 2.3 / 2.4.
- [`docs/product.md`](/docs/product.md) — no implemented capability
  surfaces to users yet; the organizer-authoring path becomes
  user-reachable when the per-event admin UI lands in 2.2.
- [`docs/dev.md`](/docs/dev.md) — no new validation commands.
- [`docs/open-questions.md`](/docs/open-questions.md) — the post-MVP
