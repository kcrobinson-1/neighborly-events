...
([`m2-phase-2-1-1-plan.md`](/docs/plans/archive/m2/m2-phase-2-1-1-plan.md)) — Landed —
...
[`docs/architecture.md`](/docs/architecture.md) updates, and this parent
...
content); [`m2-admin-restructuring.md`](/docs/plans/archive/m2/m2-admin-restructuring.md)
...
- [`supabase/migrations/20260421000300_add_redeem_entitlement_rpc.sql`](/supabase/migrations/20260421000300_add_redeem_entitlement_rpc.sql)
  ...
  ([`m2-admin-restructuring.md`](/docs/plans/archive/m2/m2-admin-restructuring.md) "Cross-Phase Decisions" §2).
- [`supabase/functions/_shared/admin-auth.ts`](/supabase/functions/_shared/admin-auth.ts)
...
7. **Run the new tests in isolation, then full pgTAP.** First the
   ...
   (per [`docs/self-review-catalog.md`](/docs/self-review-catalog.md))
...
11. **Documentation update.** Update
    [`docs/architecture.md`](/docs/architecture.md) per the "Files to
...
- [`docs/operations.md`](/docs/operations.md) — no change; the admin URL
...
- [`docs/product.md`](/docs/product.md) — no change; the implemented
  ...
  route lands in 2.2.
- [`docs/dev.md`](/docs/dev.md) — no change; no new validation commands.
