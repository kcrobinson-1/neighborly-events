...
- [`docs/architecture.md`](/docs/architecture.md) — the apps/web
...
8. **Documentation pass.** Edit
   [`docs/architecture.md`](/docs/architecture.md) per the Contracts
...
- [`docs/operations.md`](/docs/operations.md),
  ...
  [`docs/backlog.md`](/docs/backlog.md) — no edit. URL ownership
...
- [`m2-admin-restructuring.md`](/docs/plans/archive/m2/m2-admin-restructuring.md) — M2
  ...
  PR's PR.
- [`m2-phase-2-2-plan.md`](/docs/plans/archive/m2/m2-phase-2-2-plan.md) — Landed sibling;
