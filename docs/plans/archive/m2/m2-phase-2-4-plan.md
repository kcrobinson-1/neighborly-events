...
| --- | --- | --- | --- |
| 2.4.1 — Add platform admin page on apps/site | [m2-phase-2-4-1-plan.md](/docs/plans/archive/m2/m2-phase-2-4-1-plan.md) | — | Landed |
| 2.4.2 — Flip routing + retarget e2e to cross-app shape | [m2-phase-2-4-2-plan.md](/docs/plans/archive/m2/m2-phase-2-4-2-plan.md) | [#124](https://github.com/kcrobinson-1/neighborly-events/pull/124) | Landed |
| 2.4.3 — Delete legacy apps/web platform admin | [m2-phase-2-4-3-plan.md](/docs/plans/archive/m2/m2-phase-2-4-3-plan.md) | [#126](https://github.com/kcrobinson-1/neighborly-events/pull/126) | Landed |

Only sub-phase **2.4.2** ships under the two-phase **Plan-to-Landed
Gate For Plans That Touch Production Smoke** from
[`docs/testing-tiers.md`](/docs/testing-tiers.md). Both 2.4.1 (purely
...
([`m2-phase-2-3-plan.md`](/docs/plans/archive/m2/m2-phase-2-3-plan.md)); 2.5 `/game/*`
...
- **Token bucket discipline.** 2.4.1 extends
  ...
  [`m2-phase-2-4-1-plan.md`](/docs/plans/archive/m2/m2-phase-2-4-1-plan.md) Contracts
...
- **2.4.2** — URL ownership shape edits. The Vercel routing
  ...
  [`docs/dev.md`](/docs/dev.md) update with the cutover. Auth e2e
  proxy `isSiteRequest` widening documented in
  [`docs/dev.md`](/docs/dev.md). Plan Status flips to `In progress
...
- **2.4.3** — apps/web module ownership edits. The
  [`docs/architecture.md`](/docs/architecture.md) apps/web admin
...
- [`m2-phase-2-4-1-plan.md`](/docs/plans/archive/m2/m2-phase-2-4-1-plan.md) — sub-phase
  2.4.1 plan (add new).
- [`m2-phase-2-4-2-plan.md`](/docs/plans/archive/m2/m2-phase-2-4-2-plan.md) — sub-phase
  2.4.2 plan (flip wiring; production smoke gate).
- [`m2-phase-2-4-3-plan.md`](/docs/plans/archive/m2/m2-phase-2-4-3-plan.md) — sub-phase
  2.4.3 plan (delete legacy).
- [`m2-phase-2-3-plan.md`](/docs/plans/archive/m2/m2-phase-2-3-plan.md) — sibling Landed
...
- [`m2-phase-2-2-plan.md`](/docs/plans/archive/m2/m2-phase-2-2-plan.md) — sibling Landed
  plan; per-event admin deep editor at `/event/:slug/admin` is the
  navigation target for `Open workspace` post-cutover.
- [`m2-phase-2-1-2-plan.md`](/docs/plans/archive/m2/m2-phase-2-1-2-plan.md) — sibling
  Landed plan; the Edge Function helper migration the platform
  admin's writes pass through unchanged.
- [`docs/testing-tiers.md`](/docs/testing-tiers.md) — Tier 5 production
