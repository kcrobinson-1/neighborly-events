...
[`docs/testing-tiers.md`](/docs/testing-tiers.md). The implementing PR
...
shell — Landed ([`m2-phase-2-2-plan.md`](/docs/plans/archive/m2/m2-phase-2-2-plan.md)); 2.4
...
[`m2-admin-restructuring.md`](/docs/plans/archive/m2/m2-admin-restructuring.md) "Sequencing,"
...
threshold per
[`m2-admin-restructuring.md`](/docs/plans/archive/m2/m2-admin-restructuring.md) "Phase
...
- [`docs/architecture.md`](/docs/architecture.md) — update URL
  ...
  table.
- [`docs/operations.md`](/docs/operations.md) — update the Vercel
...
- This plan — Status flips from `Proposed` to `In progress pending
  ...
  [`docs/testing-tiers.md`](/docs/testing-tiers.md). The Status
...
11. **Documentation pass.** Edit
    [`docs/dev.md`](/docs/dev.md) per the modify list — five edits:
    ...
    [`docs/architecture.md`](/docs/architecture.md) for URL ownership
    + Vercel routing table + apps/site adapter module entries.
    Edit [`docs/operations.md`](/docs/operations.md) for the Vercel
...
14. **Local Vercel-proxy exercise (rule-order regression check
    ...
    `vercel link` per [`docs/dev.md`](/docs/dev.md) "Vercel"
...
16. **Plan-to-PR completion gate (in-progress).** Walk every Goal,
    ...
    **`In progress pending prod smoke`** in the same PR — the
    ...
    [`docs/testing-tiers.md`](/docs/testing-tiers.md), not a
...
19. **Plan Status follow-up (doc-only commit).** Once the
    ...
    - Records the smoke run URL inline in the Status section
      ...
      [`docs/testing-tiers.md`](/docs/testing-tiers.md)'s rule
...
6. **Comment + README + docs hygiene.** `shared/db/client.ts:64`
   ...
   [`docs/operations.md`](/docs/operations.md) updates; the
   [`m2-admin-restructuring.md`](/docs/plans/archive/m2/m2-admin-restructuring.md)
...
- **Effect cleanup audit** ([catalog §Effect cleanup audit](/docs/self-review-catalog.md#L287)).
...
- **Token bucket discipline audit** ([`docs/styling.md`](/docs/styling.md)
...
- **Readiness-gate truthfulness audit** ([catalog
  ...
  [`docs/testing-tiers.md`](/docs/testing-tiers.md); hand-captured
...
- [`docs/architecture.md`](/docs/architecture.md) — URL ownership
  shape; Vercel routing topology; apps/site adapter modules.
- [`docs/operations.md`](/docs/operations.md) — Vercel routing
  description.
- [`docs/dev.md`](/docs/dev.md) — five edits per the modify list:
...
- [`docs/product.md`](/docs/product.md) — no change. The new `/`
  landing is platform chrome, not a product capability change.
- [`docs/open-questions.md`](/docs/open-questions.md) — no change.
...
- **Cross-project proxy unverifiable pre-merge.**
  ...
  *deployed* apps/site (still on main, no new routes), not to the
  ...
  from [`docs/testing-tiers.md`](/docs/testing-tiers.md) (caught by
...
- [`m2-phase-2-2-plan.md`](/docs/plans/archive/m2/m2-phase-2-2-plan.md) — sibling
