 ...
 * code at the booth…"). The location is event-owned content — other
 * events direct attendees elsewhere (riverside-jam's content names
 * the harbor stage bar) — so the line renders only for slugs
